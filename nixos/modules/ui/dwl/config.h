...
static const float focuscolor[]            = COLOR(0x00557700);
...
runorraise(const Arg *arg)
{
    Client *c;
    int found = 0;
    const char *target_id = ((char **)arg->v)[0]; /* The App ID */
    const char *cmd_path  = ((char **)arg->v)[1]; /* The command to run */

    /* Iterate through all clients to find a match */
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_CTRL,  XKB_KEY_k,           setmfact,         {.f = +0.05f} },
