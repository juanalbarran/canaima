...
in ''
  ...
  regular0=${clean (if isLight then scheme.palette.base07 else scheme.palette.base00)} # black
  ...
  regular7=${clean (if isLight then scheme.palette.base03 else scheme.palette.base05)} # white
  ...
  bright7=${clean (if isLight then scheme.palette.base04 else scheme.palette.base07)}   # bright white
